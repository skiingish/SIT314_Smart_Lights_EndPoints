...
outputPin = 38 # pin to output high voltage (postive of the LED) <-- Change depending on the test light and where it's connected. 
GPIO.setwarnings(False)
GPIO.setmode(GPIO.BOARD)
GPIO.setup(outputPin, GPIO.OUT, initial=GPIO.LOW)

# The unique device / light ID.
device_id = 'testlight006' # <-- Change this value when adding test lights.
